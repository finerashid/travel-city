...
const createCountry = async (req, res) => {
    ...
    try {
        ...
        if (countryDetails.description) { create.description = countryDetails.description };
        if (countryDetails.currency) { create.currency = countryDetails.currency };
        if (countryDetails.languages) { create.languages = countryDetails.languages };
        if (countryDetails.bestTimeToVisit) { create.bestTimeToVisit = countryDetails.bestTimeToVisit };
        if (countryDetails.safetyLevel) { create.safetyLevel = countryDetails.safetyLevel };
